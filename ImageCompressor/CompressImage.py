...
def compress_img(
    ...
    if new_size_ratio < 1.0:
        ...
        img = img.resize((int(img.size[0] *
                         ...
                         new_size_ratio)), Image.ANTIALIAS)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-q", "--quality", type=int, help="Quality ranging from a minimum of 0 (worst) to a maximum of 95 (best). Default is 90", default=25)
    parser.add_argument("-r", "--resize-ratio", type=float, help="Resizing ratio from 0 to 1, setting to 0.5 will multiply width & height of the image by 0.5. Default is 1.0", default=0.25)
